...
func TestNode(t *testing.T) {
	...
	assert.Panics(t, func() { invalidNode.GetBool() })
	...
	assert.Panics(t, func() { invalidNode.IncrInt(20) })
	assert.Panics(t, func() { invalidNode.IncrFloat(30.5) })
...
func TestSetGet(t *testing.T) {
	...
	testDefault := func(n *Node) {
		...
		assert.Equal(t, true, n.GetBool(true))
		assert.Equal(t, false, n.GetBool(false))
...
func TestIncr(t *testing.T) {
	...
	assert.Equal(t, 2, n.IncrInt(1))
	assert.Equal(t, 3.0, n.IncrFloat(1))
	assert.Equal(t, "3", n.Get())
	assert.Equal(t, "5", n.Incr(2))
	assert.Equal(t, "6.5", n.Incr(1.5))
	assert.Equal(t, 8, n.IncrInt(1.5))
	assert.Equal(t, 9.5, n.IncrFloat(1.5))
	assert.Equal(t, "0", n.Incr(-9.5))
	assert.Equal(t, "-4.5", n.Incr(-4.5))
	assert.Equal(t, -5, n.IncrInt(-1))
	assert.Equal(t, -6.5, n.IncrFloat(-1))
	assert.Equal(t, "-6.5", n.Incr(0))
	assert.Equal(t, -6, n.IncrInt(0))
	assert.Equal(t, -6.5, n.IncrFloat(0))
	assert.Panics(t, func() { n.Incr("") })
	assert.Panics(t, func() { n.IncrInt("") })
	assert.Panics(t, func() { n.IncrFloat("") })

	n.Set("0")
	assert.Equal(t, "1", n.Incr("1"))
	assert.Equal(t, "2", n.Incr("1abcdefg"))
	assert.Equal(t, 3, n.IncrInt("1abcdefg"))
	assert.Equal(t, 4.0, n.IncrFloat("1abcdefg"))

	// The following checks largest numbers representable by YDB
	// Note that such large floats don't have the resolution to represent the insignificant digits, so the addition of 1 is lost.
	n.Set("1E46")
	assert.Equal(t, 1e+46, n.IncrFloat(1))
	n.Set("-1E46")
	assert.Equal(t, -1e+46, n.IncrFloat(1))
}
