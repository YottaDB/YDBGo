...
//  */
// extern void YDBWrapperPanic(int sigtype);
// void ydb_gowrapper_panic_callback(int sigtype);
// void ydb_gowrapper_panic_callback(int sigtype)
// {
//         YDBWrapperPanic(sigtype);
// }
// /* C routine to fetch the address of ydb_gowrapper_panic_callback */
// void *ydb_get_gowrapper_panic_callback_funcvp(void);
// void *ydb_get_gowrapper_panic_callback_funcvp(void)
// {
//        return (void *)&ydb_gowrapper_panic_callback;
// }
import "C"
